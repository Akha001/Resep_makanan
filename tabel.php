...
<body>
	<div class="container">
			<div class="w3-sidebar w3-bar-block w3-dark-grey w3-animate-left" style="display:none" id="mySidebar">
				...
				<a href="tabel.php" class="w3-bar-item w3-button w3-hover-red">Home</a>
				<a href="tambah.php" class="w3-bar-item w3-button w3-hover-lime">Tambah Resep</a>
				<a href="admin.php" class="w3-bar-item w3-button w3-hover-grey">Back</a>
			</div>
...
function w3_close() {
    ...
    <tbody>
      ...
      while($row = mysqli_fetch_array($tampilMas))
      {
       ...
       <tr height="100px">
        ...
        <td>Klik<input type="button" name="view" value="Detail" data-id="<?php echo $row['id']; ?>" class="btn btn-info btn-xs view_data">untuk melihat bahan...</td>
    ...
    <div style="font-weight:bold; text-align:center;">
        ...
        <?php
            for ($i=1; $i<=$pages ; $i++){
        ?>
            <a href="tabel.php?halaman=<?php echo $i; ?>" style="text-decoration:none;">   <u><?php echo $i; ?></u></a>
        <?php
            }
        ?>
    </div>
