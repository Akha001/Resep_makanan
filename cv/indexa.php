        ...
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
          <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation">
              <ul class="navbar-nav">
			  <li class="nav-item"><a class="nav-link smooth-scroll" href="../admin.php">Home</a></li>
...
<div class="profile-page">
  <div class="wrapper">
    <div class="page-header page-header-small" filter-color="green">
      <div class="page-header-image" data-parallax="true" style="background-image: url('images/nime3.jpg');"></div>
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="images/souma3.gif" alt="Image"/></a></div>
          <div class="h2 title">Kurnia Bintang Sakha Perdana</div>
          <p class="category text-white">Web Developer, Gamer</p><a class="btn btn-primary smooth-scroll mr-2" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Hire Me</a>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <p>Hello! Saya Kurnia Bintang Sakha Perdana(Akha). Web Developer,dari program ini.</p>
            <p>Web Resep Makanan ini saya buat untuk memudahkan orang-orang yang ingin melihat lihat resep menu makanan yang belom pernah mereka ketahui,
			 web ini telah saya buat dengan desain responsive menurut skill dan pengalaman saya.
          </div>
        </div>
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-8">17</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Email:</strong></div>
              <div class="col-sm-8">bintanglakaus@gmail.com</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
              <div class="col-sm-8">0893-2778-5211</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Address:</strong></div>
              <div class="col-sm-8">Surakarta,Jawa Tengah,Indonesia</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-education-header">
            <p>2018-2021</p>
            <div class="h5">SMK</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Master of Information Technology</div>
            <p class="category">SMK N 6 SURAKARTA</p>
            <p>Mendapat ilmu web lanjutan dari sejak SMK. Dan pratek kerja lapangan dengan suatu perusahaan pembuatan aplikasi dan web.</p>
          </div>
        </div>
      </div>
    </div>
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-education-header">
            <p>2015 - 2018</p>
            <div class="h5">SMP</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Bachelor of Computer Science</div>
            <p class="category">SMP N 2 SURAKARTA</p>
            <p>Mendapat ilmu start dari SMP tentang Inforrmatika dan Telekomunikasi, dan mendapat ilmu dari berbagai sumber orang pada saat SMP.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="carousel slide" id="cc-Indicators" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="row">
              <div class="col-lg-2 col-md-3 cc-reference-header"><img src="images/amle.png" alt="Image"/>
                <div class="h5 pt-2">Aiyana</div>
                <p class="category">CEO / WEBM</p>
              </div>
              <div class="col-lg-10 col-md-9">
                <p> Aiyana-san adalah orang yang dulunya menginspirasi dari suatu yang pekerjaan yang di tekuni dan banggakan. Dia memberitahukan bahwa setiap ilmu yang kita dapat dari guru itu bukan lah sia-sia akan tetapi itu adalah senjata untuk kita bertahan hidup dan mencari kehidupan yang lebih baik.</p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            <div class="row">
              <div class="col-lg-2 col-md-3 cc-reference-header"><img src="images/botak.png" alt="Image"/>
                <div class="h5 pt-2">Botak</div>
                <p class="category">CEO / Creativem</p>
              </div>
              <div class="col-lg-10 col-md-9">
                <p> Dia adalah Pak Shikuwa dari Jepang dia orangnya asik dan dia dipanggil botak karan dia memang botak. Tapi dia adalah seorang motivator tentang usaha, dia pernah menceritakan kisah dia dulu waktu susah sampai sukses sekarang. Sampai dia pernah bilang "Sesuatu yang dilakukan tanpa ikhlas dan niat usaha tidak akan membuatmu bahagia, jadi lakukan kegiatan mu dengan apa yang bisa membuatmu ikhlas menjalaninya".</p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            <div class="row">
              <div class="col-lg-2 col-md-3 cc-reference-header"><img src="images/boy.png" alt="Image"/>
                <div class="h5 pt-2">Wu-Bai</div>
                <p class="category">CEO / Gamer Master</p>
              </div>
              <div class="col-lg-10 col-md-9">
                <p> Kak Wu-Bai atau biasa dipanggil Xio Bai. Saya terinspirasi dari dia karena bakat bermain game yang profesional dan kerja kerasnya juga. Dia juga pernah mengambil jurusan pemrograman di Cina dan pernah mengikuti kompetisi Pemrograman terbesar di Cina. Satu kata yang pernah saya ingat dari dia yaitu "Pantang menyerah adalah hal yang harus ada di diri kita karna tanpa itu hidup kita pasti sudah selesai sejak dulu kala".</p>
              </div>
            </div>
          </div>
        </div>
...
<div class="section" id="contact">
  <div class="cc-contact-information" style="background-image: url('images/stasolo.png');">
    <div class="container">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="card-body">
                    ...
                    <p class="pb-2">Surakarta,Jawa Tengah,Indnesia</p>
                    <p class="mb-0"><strong>Phone</strong></p>
                    <p class="pb-2">0893-2778-5211</p>
                    <p class="mb-0"><strong>Email</strong></p>
                    <p>bintanglakaus@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <footer class="footer">
      ...
      <div class="h4 title text-center">Kurnia Bintang Sakha Perdana</div>
      <div class="text-center text-muted">
        <p>&copy; Creative CV. All rights reserved.<br>Design by- <a class="credit" href="https://templateflip.com" target="_blank">TemplateFlip</a></p>
      </div>
    </footer>
